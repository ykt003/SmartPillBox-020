package com.rilintech.adapter;


import java.text.SimpleDateFormat;
import java.util.Date;

import com.rilintech.controller.HistoryActivity;
...
import com.rilintech.unit.LunarCalendar;
import com.rilintech.unit.SpecialCalendar;
...
//		}
		...
		if(currentFlag == position&&!HistoryActivity.isSelected){ 	
			//设置当天的背景
			drawable = res.getDrawable(R.drawable.current_day_bgc);
		...
		if(HistoryActivity.isSelected&&HistoryActivity.selectedPosition==position){
